...
exports.uploadImageToCloudinary = async (file, folder, height, quality) => {
  ...
  try {
    // Diagnostic: print cloud config being used (do not log secrets)
    try {
      const cfg = cloudinary.config();
      console.log("Cloudinary config (diagnostic):", { cloud_name: cfg.cloud_name ? String(cfg.cloud_name) : null, api_key: cfg.api_key ? "<set>" : null });
    } catch (e) {
      console.warn("Could not read cloudinary config for diagnostics.");
    }
